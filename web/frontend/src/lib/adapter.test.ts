      ...
      mention_results: [
        {
          ...
          status: "linked",
          linked_entity: { entity_id: "DV-ALM-002", entity_type: "alarm", entity_name: "cert expire", alias: [], desc: "", relationships: [], source: "catalog", data_layer: "L1_SANITIZED" },
          candidates: [],
          confidence: 0.99,
    ...
    const result = baseResult({
      mention_results: [
        ...
        },
        {
          ...
          status: "linked",
          linked_entity: { entity_id: "DV-KPI-MTK-001", entity_type: "kpi_meas_type_key", entity_name: "CPU Usage", alias: [], desc: "", relationships: [], source: "catalog", data_layer: "L0_SYNTHETIC" },
          candidates: [],
          confidence: 0.99,
      ...
      mention_results: [
        {
          ...
          status: "linked",
          linked_entity: { entity_id: "DV-NE-NAME-001", entity_type: "ne_name", entity_name: "CBS_1", alias: [], desc: "", relationships: [], source: "v3_gauss_mock", data_layer: "L2_SIMULATED_INTERFACE" },
          candidates: [],
          confidence: 0.95,
